...
SWIFT_CLASS("_TtC11TrainingKit14SessionGateway") SWIFT_AVAILABILITY(watchos,introduced=8.0)
...
@class NSDate;
@interface SessionGateway (SWIFT_EXTENSION(TrainingKit)) <HKWorkoutSessionDelegate>
- (void)workoutSession:(HKWorkoutSession * _Nonnull)_ didChangeToState:(HKWorkoutSessionState)toState fromState:(HKWorkoutSessionState)fromState date:(NSDate * _Nonnull)_;
